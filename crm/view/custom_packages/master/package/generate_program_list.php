    ...
    <table id="dynamic_table_list" style="width:100%" name="dynamic_table_list">
        ...
        <tr>
            ...
            <td class='col-md-6 pad_8' style="max-width: 594px;overflow: hidden;"><textarea
                    id="day_program<?php echo $i; ?>" name="day_program" class="form-control mg_bt_10"
                    placeholder="*Day<?php echo $i; ?> Program" title="Day-wise Program"
                    onchange="validate_spaces(this.id);validate_dayprogram(this.id);" rows="3" value=""></textarea>
            </td>
