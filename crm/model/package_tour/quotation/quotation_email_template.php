            ...
            <div class="tab-content responsive">
              ...
              <div role="tabpanel" class="tab-pane" id="terms">
                <pre><?php
                    ...
                    if($sq_tnc_count > 0 ){
                        $sq_query = mysqli_num_rows(mysqlQuery("select terms_and_conditions from terms_and_conditions where type='Package Quotation' and dest_id='$sq_tours_package[dest_id]' and active_flag='Active'"));
                    }else{
                        $sq_query = mysqli_num_rows(mysqlQuery("select terms_and_conditions from terms_and_conditions where type='Package Quotation' and dest_id='0' and active_flag='Active'"));
                    }
